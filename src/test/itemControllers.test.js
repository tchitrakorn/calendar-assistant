...
describe('Item Controllers', () => {
    ...
    describe('manage function', () => {
        beforeEach(() => {
            db.logUserEvent.mockResolvedValue(null)
            calendarModel.writeCalendar.mockResolvedValue({
        ...
        it('should log user event and write to calendar', async () => {
            ...
            expect(calendarModel.writeCalendar).toHaveBeenCalledWith(
                mockRequest
            )
    ...
    describe('manageUserData function', () => {
        ...
        it('should update user data for given email and fields', async () => {
            const result = await itemControllers.manageUserData(
                mockEmail,
                mockFieldsToUpdate
            )
            expect(dataModel.writeData).toHaveBeenCalledWith(
                mockEmail,
                mockFieldsToUpdate
            )
